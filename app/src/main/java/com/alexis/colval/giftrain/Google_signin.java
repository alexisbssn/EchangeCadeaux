...
//Got help from google's sample: https://github.com/googlesamples/google-services/blob/master/android/signin/
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            if(!profileHelper.idExists(googleId)){
                ...
                values.put(DatabaseContracts.ProfileEntry.COLUMN_NAME_FNAME, personName);
